  ...
  <div class="page-root">
    ...
    <div class="page-wrapper">
      ...
      <header class="page-header">
        ...
        <p class="subheadline">
          Your satisfaction is our priority. Please review our return guidelines
          carefully to ensure a smooth and hassle-free experience.
        </p>
      ...
      <main class="policy-card">
        ...
        <div v-else-if="error" class="state-box">
          ...
          <button class="retry-btn" @click="fetchReturnPolicy">Try again</button>
        </div>
        ...
        <ol v-else class="policy-list">
          ...
          >
            <div class="item-index">{{ String(item.step_number ?? index + 1).padStart(2, '0') }}</div>
            <div class="item-body">
      ...
      <footer class="page-footer">
        <p>Questions about returns? <a href="mailto:info@vaibhavskatingacademy.com" class="footer-link">Contact support</a></p>
  ...
  setup() {
    ...
    const fetchReturnPolicy = async () => {
      ...
      try {
        ...
        returnItems.value = await response.json()
      } catch (err) {
        console.error(err)
    ...
    onMounted(fetchReturnPolicy)

    return { returnItems, loading, error, fetchReturnPolicy, lastUpdated }
  }
}
</script>
