  ...
  <div class="page-root">
    ...
    <div class="page-wrapper">
      ...
      <header class="page-header">
        ...
        <p class="subheadline">
          We strive to deliver your orders safely and on time.
      ...
      <main class="policy-card">
        ...
        <div v-else-if="error" class="state-box">
          ...
          <button class="retry-btn" @click="fetchShippingPolicy">Try again</button>
        </div>
        ...
        <ul v-else class="policy-list">
          ...
          >
            ...
            <div class="item-body item-content" v-html="item.content"></div>
      ...
      <footer class="page-footer">
        <p>Questions about shipping? <a href="mailto:info@vaibhavskatingacademy.com" class="footer-link">Contact support</a></p>
  ...
  setup() {
    ...
    const fetchShippingPolicy = async () => {
      ...
      try {
        ...
        shippingItems.value = await response.json()
      } catch (err) {
        console.error(err)
    ...
    onMounted(fetchShippingPolicy)

    return { shippingItems, loading, error, fetchShippingPolicy, lastUpdated }
  }
}
</script>
