  ...
  <div class="page-root">
    ...
    <div class="page-wrapper">
      ...
      <header class="page-header">
        ...
        <p class="subheadline">
          We believe in fair and transparent practices. Please review our
          cancellation and refund policies to understand your options.
        </p>
      ...
      <footer class="page-footer">
        <p>Questions about cancellations or refunds? <a href="mailto:info@vaibhavskatingacademy.com" class="footer-link">Contact support</a></p>
